function survey_data(buoyNo,diskNo,frameSize)
...
saveDir = strcat('D:/Personal Folders/jlebien/DolphinData/Buoy',buoyNo,'/Detections/');
diary(strcat(saveDir,'textlog_',buoyNo,diskNo,'_',num2str(nsaves),'.txt'));
diary on

tic
for i = 3:length(fileList) % hidden files . and ..
